...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_manipulation-srv:<SetSpeed-request> is deprecated: use dynamixel_manipulation-srv:SetSpeed-request instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:speed-val is deprecated.  Use dynamixel_manipulation-srv:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetSpeed-request>)))
  ...
  "dynamixel_manipulation/SetSpeedRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetSpeed-request)))
  "Returns string type for a service object of type 'SetSpeed-request"
  "dynamixel_manipulation/SetSpeedRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_manipulation-srv:<SetSpeed-response> is deprecated: use dynamixel_manipulation-srv:SetSpeed-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetSpeed-response>)))
  ...
  "dynamixel_manipulation/SetSpeedResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetSpeed-response)))
  "Returns string type for a service object of type 'SetSpeed-response"
  "dynamixel_manipulation/SetSpeedResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetSpeed)))
  ...
  "dynamixel_manipulation/SetSpeed")