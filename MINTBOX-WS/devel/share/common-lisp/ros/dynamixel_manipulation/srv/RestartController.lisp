...
(cl:in-package dynamixel_manipulation-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <RestartController-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RestartController-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_manipulation-srv:<RestartController-request> is deprecated: use dynamixel_manipulation-srv:RestartController-request instead.")))

(cl:ensure-generic-function 'port_name-val :lambda-list '(m))
(cl:defmethod port_name-val ((m <RestartController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:port_name-val is deprecated.  Use dynamixel_manipulation-srv:port_name instead.")
  (port_name m))

(cl:ensure-generic-function 'package_path-val :lambda-list '(m))
(cl:defmethod package_path-val ((m <RestartController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:package_path-val is deprecated.  Use dynamixel_manipulation-srv:package_path instead.")
  (package_path m))

(cl:ensure-generic-function 'module_name-val :lambda-list '(m))
(cl:defmethod module_name-val ((m <RestartController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:module_name-val is deprecated.  Use dynamixel_manipulation-srv:module_name instead.")
  (module_name m))

(cl:ensure-generic-function 'class_name-val :lambda-list '(m))
(cl:defmethod class_name-val ((m <RestartController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:class_name-val is deprecated.  Use dynamixel_manipulation-srv:class_name instead.")
  (class_name m))

(cl:ensure-generic-function 'controller_name-val :lambda-list '(m))
(cl:defmethod controller_name-val ((m <RestartController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:controller_name-val is deprecated.  Use dynamixel_manipulation-srv:controller_name instead.")
  (controller_name m))

(cl:ensure-generic-function 'dependencies-val :lambda-list '(m))
(cl:defmethod dependencies-val ((m <RestartController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:dependencies-val is deprecated.  Use dynamixel_manipulation-srv:dependencies instead.")
  (dependencies m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RestartController-request>)))
  ...
  "dynamixel_manipulation/RestartControllerRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RestartController-request)))
  "Returns string type for a service object of type 'RestartController-request"
  "dynamixel_manipulation/RestartControllerRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RestartController-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RestartController-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_manipulation-srv:<RestartController-response> is deprecated: use dynamixel_manipulation-srv:RestartController-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <RestartController-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:success-val is deprecated.  Use dynamixel_manipulation-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'reason-val :lambda-list '(m))
(cl:defmethod reason-val ((m <RestartController-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_manipulation-srv:reason-val is deprecated.  Use dynamixel_manipulation-srv:reason instead.")
  (reason m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RestartController-response>)))
  ...
  "dynamixel_manipulation/RestartControllerResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RestartController-response)))
  "Returns string type for a service object of type 'RestartController-response"
  "dynamixel_manipulation/RestartControllerResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RestartController)))
  ...
  "dynamixel_manipulation/RestartController")