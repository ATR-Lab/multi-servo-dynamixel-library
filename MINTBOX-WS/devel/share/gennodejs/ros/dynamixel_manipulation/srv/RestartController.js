...
// (in-package dynamixel_manipulation.srv)
...
class RestartControllerRequest {
  ...
  static datatype() {
    ...
    return 'dynamixel_manipulation/RestartControllerRequest';
  }
...
class RestartControllerResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dynamixel_manipulation/RestartControllerResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'dynamixel_manipulation/RestartController'; }
};
