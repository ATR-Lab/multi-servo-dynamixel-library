...
class StartControllerRequest {
  ...
  static datatype() {
    ...
    return 'dynamixel_manipulation/StartControllerRequest';
  }
...
class StartControllerResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dynamixel_manipulation/StartControllerResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'dynamixel_manipulation/StartController'; }
};
