// Generated by gencpp from file dynamixel_manipulation/StartControllerRequest.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_MANIPULATION_MESSAGE_STARTCONTROLLERREQUEST_H
#define DYNAMIXEL_MANIPULATION_MESSAGE_STARTCONTROLLERREQUEST_H
...
struct StartControllerRequest_
{
  ...
  typedef boost::shared_ptr< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> const> ConstPtr;

}; // struct StartControllerRequest_

typedef ::dynamixel_manipulation::StartControllerRequest_<std::allocator<void> > StartControllerRequest;

typedef boost::shared_ptr< ::dynamixel_manipulation::StartControllerRequest > StartControllerRequestPtr;
typedef boost::shared_ptr< ::dynamixel_manipulation::StartControllerRequest const> StartControllerRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_manipulation::StartControllerRequest_<ContainerAllocator>& v)
  {
    s << indent << "port_name: ";
...
#endif // DYNAMIXEL_MANIPULATION_MESSAGE_STARTCONTROLLERREQUEST_H
