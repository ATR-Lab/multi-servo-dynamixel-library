// Generated by gencpp from file dynamixel_manipulation/RestartControllerRequest.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_MANIPULATION_MESSAGE_RESTARTCONTROLLERREQUEST_H
#define DYNAMIXEL_MANIPULATION_MESSAGE_RESTARTCONTROLLERREQUEST_H
...
struct RestartControllerRequest_
{
  ...
  typedef boost::shared_ptr< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> const> ConstPtr;

}; // struct RestartControllerRequest_

typedef ::dynamixel_manipulation::RestartControllerRequest_<std::allocator<void> > RestartControllerRequest;

typedef boost::shared_ptr< ::dynamixel_manipulation::RestartControllerRequest > RestartControllerRequestPtr;
typedef boost::shared_ptr< ::dynamixel_manipulation::RestartControllerRequest const> RestartControllerRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator1> & lhs, const ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7785d708c83a180bULL;
  static const uint64_t static_value2 = 0xefd2fe3450dd9d41ULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_manipulation::RestartControllerRequest_<ContainerAllocator>& v)
  {
    s << indent << "port_name: ";
...
#endif // DYNAMIXEL_MANIPULATION_MESSAGE_RESTARTCONTROLLERREQUEST_H
